...
class _SignInScreenState extends ConsumerState<SignInScreen> {
  ...
  void initState() {
    super.initState();
    _usernameController.text = ref.read(userLocalStorageProvider).lastUsedUsername ?? '';
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SpaceH24(),
                Text(StringConst.welcome, style: AppTextStyles.cabinBold24DarkBlue),
                const SpaceH8(),
                Text(
                ...
                AppTextField(
                  ...
                  prefixIcon: const Icon(Icons.lock_outline, color: AppColors.mutedGray, size: Sizes.ICON_SIZE_20),
                ),
                const SpaceH8(),
                Align(
                ...
                AppButton(
                  ...
                  isLoading: authState.isLoading, // Use loading state from provider
                ),
                const SpaceH48(),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text(StringConst.noAccountPrompt, style: AppTextStyles.cabinRegular14MutedGray),
                    TextButton(
                      onPressed: _navigateToSignUp,
                      child: const Text(StringConst.createOne, style: AppTextStyles.cabinRegular14Primary),
                    ),
                  ],
                ),
                const SpaceH48(),
