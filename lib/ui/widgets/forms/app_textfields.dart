...
class AppTextField extends StatefulWidget {
  ...
  }) : assert(type != AppTextFieldType.dropdown || (dropdownItems != null && onDropdownChanged != null),
  ...
  // Assertion for confirm password to ensure originalPasswordController is provided
        assert(type != AppTextFieldType.confirmPassword || originalPasswordController != null,
...
class _AppTextFieldState extends State<AppTextField> {
  ...
  void initState() {
    ...
    if (widget.type == AppTextFieldType.confirmPassword && widget.originalPasswordController != null) {
      widget.originalPasswordController!.addListener(_revalidateConfirmPassword);
    }
  }
  ...
  void dispose() {
    ...
    if (widget.type == AppTextFieldType.confirmPassword && widget.originalPasswordController != null) {
      widget.originalPasswordController!.removeListener(_revalidateConfirmPassword);
    }
    super.dispose();
  }
  ...
  String? Function(String?)? _getValidator() {
    ...
    switch (widget.type) {
      ...
      default:
        return (value) => (value == null || value.isEmpty) ? '${widget.label} is required' : null;
    }
  }
  ...
  void _checkPasswordStrength(String password) {
    if (!widget.showPasswordStrength || widget.type != AppTextFieldType.password) return;
  ...
  Widget _buildPasswordStrengthIndicator() {
    if (widget.type != AppTextFieldType.password || !widget.showPasswordStrength) {
    ...
    return DropdownButtonFormField<String>(
      ...
      decoration: InputDecoration(
        ...
        contentPadding: const EdgeInsets.symmetric(
            vertical: Sizes.PADDING_14, horizontal: Sizes.PADDING_16),
        hintText: widget.hintText,
        hintStyle: AppTextStyles.interRegular14HintGray,
        errorStyle: AppTextStyles.cabinRegular11mutedGray.copyWith(color: AppColors.red),
      ...
      icon: widget.suffixIcon ?? const Icon(Icons.keyboard_arrow_down_rounded, color: AppColors.mutedGray),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const Icon(Icons.keyboard_arrow_down_rounded, color: AppColors.mutedGray, size: Sizes.ICON_SIZE_20),
  ...
  Widget build(BuildContext context) {
    final bool shouldObscure =
        (widget.type == AppTextFieldType.password || widget.type == AppTextFieldType.confirmPassword)
            && !_isPasswordVisible;
      ...
      children: [
        ...
        TextFormField(
          ...
          onChanged: (value) {
            ...
            if (widget.type == AppTextFieldType.confirmPassword && widget.controller != null) {
              (context as Element).markNeedsBuild();
            }
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: (widget.type == AppTextFieldType.password || widget.type == AppTextFieldType.confirmPassword)
                ? IconButton(
              icon: Icon(
